...
╠══════════════════════════════════════════════════════════════════════════════╣
║  API:  Expose Ifá functions to be called from Python/Rust/C                  ║
║  FFI:  Call external libraries (C, Rust, Python) from Ifá-Lang               ║
║                                                                              ║
║  The 16 Odù as API Endpoints:                                                ║
║    - Each Odù domain becomes a REST/RPC-like module                          ║
