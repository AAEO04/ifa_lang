...
fn execute_to_completion(
    vm: &mut IfaVM,
    bytecode: &ifa_vm::bytecode::Bytecode,
...
fn conformance_vm_propagate_error_unwraps_ok_and_throws_err() {
    ...
    ok_bytecode.code = vec![
        ifa_vm::OpCode::LoadGlobal as u8,
        0,
        0,
        ifa_vm::OpCode::PropagateError as u8,
        ifa_vm::OpCode::Return as u8,
    ];
    ...
    err_bytecode.code = vec![
        ...
        0,
        ifa_vm::OpCode::PropagateError as u8,
        ifa_vm::OpCode::TryEnd as u8,
        ifa_vm::OpCode::PushInt as u8,
        7,
        0,
        0,
        0,
