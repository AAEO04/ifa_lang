...
fn get_completions(context: &Option<LintContext>) -> Vec<CompletionItem> {
    let mut items = vec![
        ...
        ci(
            "Ogbe",
            "The Light (System/Lifecycle)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Oyeku",
            "The Darkness (Exit/Cleanup)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Iwori",
            "The Mirror (Time/Loops)",
            CompletionItemKind::MODULE,
        ),
        ci("Odi", "The Vessel (File I/O)", CompletionItemKind::MODULE),
        ci(
            "Irosu",
            "The Speaker (Log/Print)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Owonrin",
        ...
        ci(
            "Okanran",
            "The Troublemaker (Errors)",
            CompletionItemKind::MODULE,
        ),
        ci("Ogunda", "The Cutter (Arrays)", CompletionItemKind::MODULE),
        ci(
            "Osa",
            "The Wind (Flow/Concurrency)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Ika",
            "The Constrictor (Strings)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Oturupon",
            "The Bearer (Reduce/Div)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Otura",
        ...
        ci(
            "Ose",
            "The Beautifier (UI/Graphics)",
            CompletionItemKind::MODULE,
        ),
        ci(
            "Ofun",
            "The Creator (Root/Perms)",
            CompletionItemKind::MODULE,
        ),
