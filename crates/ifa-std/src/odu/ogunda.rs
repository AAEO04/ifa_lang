...
impl Ogunda {
    ...
    pub fn sise(&self, command: &str, args: &[&str]) -> IfaResult<Output> {
        ...
        self.esu.enforce_crossroads(
            &crate::sandbox_shim::Ofun::Execute {
                programs: vec![command.to_string()],
            },
            "Ogunda.sise",
        )?;
    ...
    pub fn ayika(&self, key: &str) -> IfaResult<Option<String>> {
        self.esu.enforce_crossroads(
            &crate::sandbox_shim::Ofun::Environment {
...
mod tests {
    ...
    #[test]
    fn test_list_ops() {
        let ogunda = Ogunda::new(crate::esu::Esu::default());
