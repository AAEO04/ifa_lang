...
impl Obara {
    ...
    // Trigonometry
    pub fn sin(&self, x: f64) -> f64 { x.sin() }
    pub fn cos(&self, x: f64) -> f64 { x.cos() }
    pub fn tan(&self, x: f64) -> f64 { x.tan() }
    pub fn asin(&self, x: f64) -> f64 { x.asin() }
    pub fn acos(&self, x: f64) -> f64 { x.acos() }
    pub fn atan(&self, x: f64) -> f64 { x.atan() }
    
    // Logarithms
    pub fn log(&self, x: f64) -> f64 { x.ln() }
    pub fn log10(&self, x: f64) -> f64 { x.log10() }
    pub fn exp(&self, x: f64) -> f64 { x.exp() }
    ...
    // Constants
    pub fn pi(&self) -> f64 { std::f64::consts::PI }
    pub fn e(&self) -> f64 { std::f64::consts::E }
}
